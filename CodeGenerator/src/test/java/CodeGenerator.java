...
public class CodeGenerator {
     ...
     * modular 名字
     */
    public static final String MODULAR_NAME = "";//"J4DataCenterService/";
     ...
     * 作者
     */
    public static final String AUTHOR = "xxxx";
    /**
     * 是否是 rest 接口
     */
...
//        String moduleName = scanner("模块名").toLowerCase();
        String tableName = scanner("表名");
//        String tablePrefix = scanner("表前缀(无前缀输入#)").replaceAll("#", "");
        autoGenerator(null, tableName, "#");
    }
